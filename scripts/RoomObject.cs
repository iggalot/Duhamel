...
{
    public partial class RoomObject : CharacterBody2D
    {
        ...
        public override void _PhysicsProcess(double delta)
        {
            ...
            if (collision != null)
            {
               ...
               //GD.Print("RoomObject collided with " + collision.GetCollider() + " at " + GlobalPosition);

                var collider_obj = collision.GetCollider();
                
                if (collision.GetCollider() is MonsterObject)
                {
                    GD.Print("Room object hit a monster: " + ((Node)collision.GetCollider()).Name);
                ...
                {
                    GD.Print("Room object hit a room object");
                }
                ...
                {
                    GD.Print("Room object hit something else");
                }
